                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <script>                                         var jatah_peminjaman = <?php echo $data['jatah_lama_pinjam']; ?>; var lama_pinjam_hari = <?php echo $lama_pinjam_hari; ?>;
                                            var telat = lama_pinjam_hari - jatah_peminjaman; var denda = 0;
                                            if (lama_pinjam_hari > jatah_peminjaman) { denda = 2000 * telat; }
                                            var denda_rupiah = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR' }).format(denda); document.getElementById('kolomDenda<?php echo $nomor; ?>').textContent = denda_rupiah;
                                        </script>
                                    </td>
                                    <td>
                                        <a href="report/peminjaman_satu.php?id=<?= $data['id'] ?>" target="_blank"
